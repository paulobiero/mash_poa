...
class TicketSearchResultsBoardingDropOffRound extends StatefulWidget {
  const TicketSearchResultsBoardingDropOffRound({Key? key, required this.title,required this.buildContext,required this.from,required this.to, required this.onPageChanged}) : super(key: key);
  ...
  @override
  State<TicketSearchResultsBoardingDropOffRound> createState() => _TicketSearchResultsBoardingDropOffRound();
}
class _TicketSearchResultsBoardingDropOffRound extends State<TicketSearchResultsBoardingDropOffRound>with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    GetListData(context).getBoardingDroppingPoints(widget.from.id,widget.to.id,widget.title,AppUrl.tripListModel.bus_id,(list1,list2){
