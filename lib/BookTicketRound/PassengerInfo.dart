import 'package:mash/BookTicketRound/TicketSearchResultsRound.dart';
...
class PassengerInfo extends StatefulWidget {
  ...
  final Function(List<BookingPassengerModel>, List<BookingPassengerModel>)
      onPageChanged;
...
class _PassengerInfo extends State<PassengerInfo> {
  ...
  void initState() {
    ...
    AppUrl.passengersReturn.forEach((element) {
      BookingPassengerModel bookingPassengerModel = BookingPassengerModel(
          seatItem: element.seat, fareModel: element.fareModel);
      passengersReturn.add(bookingPassengerModel);
    });
    AuthenticationServices().getUser().then((value) => {
          showDialog(
              context: context,
              builder: (BuildContext ctx) {
                return AlertDialog(
                  ...
                  content:
                      const Text('Are you sure the one who is travelling?'),
                  actions: [
                    TextButton(
                        onPressed: () {
                          // Close the dialog
                    ...
                    TextButton(
                        onPressed: () {
                          ...
                          setState(() {
                            ...
                            passengersReturn[0].first_name =
                                userInfo.name.split(" ").first;
                            passengersReturn[0].last_name =
                                userInfo.name.split(" ").last;
                            passengersReturn[0].phone = userInfo.phone;
                            passengersReturn[0].idNumber = userInfo.id_number;
  ...
  List<BookingPassengerModel> passengersReturn = [];
        ...
        floatingActionButton: GestureDetector(
          ...
          onTap: () async {
            if (validateTheForm(passengers) && email.isNotEmpty) {
              ...
              widget.onPageChanged(passengers, passengersReturn);
              AppUrl.email = email;
            } else {
            ...
            children: <Widget>[
                ...
                child: Row(
                  ...
                  children: [
                    index == 0
                        ...
                        : SizedBox(),
                    Text(
                      'Seat ${listModel.seatItem.seat_name},${passengersReturn[index].seatItem.seat_name}',
                      style: TextStyle(
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      onChanged: (s) {
                        ...
                        passengersReturn[index].first_name = s;
                        passengers[index].first_name = s;
                      },
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      onChanged: (s) {
                        ...
                        passengersReturn[index].last_name = s;
                        passengers[index].last_name = s;
                      },
                      textCapitalization: TextCapitalization.words,
                      inputFormatters: <TextInputFormatter>[
                        UpperCaseTextFormatter()
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (s) {
                    listModel.phone = s;
                    passengersReturn[index].phone = s;
                    passengers[index].phone = s;
                  },
                  decoration: InputDecoration(
                      border: InputBorder.none,
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (s) {
                    ...
                    passengersReturn[index].idNumber = s;
                    passengers[index].idNumber = s;
                  },
