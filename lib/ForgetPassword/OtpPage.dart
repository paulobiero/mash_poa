...
class _OtpPage extends State<OtpPage> {
  ...
  Widget field({FocusNode? focus, FocusNode? next, bool autofocus = false,required void Function(String?)onSaved}) {
    return Container(
                      ...
                      Positioned(
                        ...
                        child:RichText(
                          text: TextSpan(
                            ...
                            children:  <TextSpan>[
                              TextSpan(text: ' OTP ', style: TextStyle(fontWeight: FontWeight.bold,color: Colors.yellow.shade700)),
                ...
                Container(
                  ...
                  Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          Text('Code is sent to +254${widget.title}',
                         ...
                         Form(
                           ...
                           children: [
                             FadeAnimation(
                                 delay: 200,
                                 child: field(
                                     focus: _field1, next: _field2, autofocus: true,onSaved: (s){
                                   setState(() {
                                     text1=s!;
                                   });
                                 })),
                             FadeAnimation(
                                 delay: 400,
                                 child: field(focus: _field2, next: _field3,onSaved: (s){
                                   setState(() {
                                     text2=s!;
                                   });
                                 })),
                             FadeAnimation(
                                 delay: 600,
                                 child: field(focus: _field3, next: _field4,onSaved: (s){
                                   setState(() {
                                     text3=s!;
                                   });
                                 })),
                             FadeAnimation(delay: 800, child: field(focus: _field4,next: _field5,onSaved: (s){
                               setState(() {
                                 text4=s!;
                               });
                             })
                             ...
                             FadeAnimation(delay: 1000, child: field(focus: _field5,next: _field6,onSaved: (s){
                               setState(() {
                                 text5=s!;
                               });
                             })
                             ...
                             FadeAnimation(delay: 1200, child: field(focus: _field6,onSaved: (s){
                               setState(() {
                                 text6=s!;
                               });
                             })
                            ...
                            child: GestureDetector(
                              ...
                              onTap: (){
                                ...
                                if (form!.validate()) {
                                  ...
                                  pr.show();
                                  AuthenticationServices().verifyOTP2(widget.title, texts).then((value) =>
                                  {
                                  pr.hide(),
                                    if(value['status'])
                                      {
                                ...
                                builder: (BuildContext context) =>  SignUpPage(title: widget.title,),
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar( const SnackBar(
                                        behavior: SnackBarBehavior.floating,
                                        content: Text("OTP verification Error,use the correct OTP"),
                                        duration: Duration(seconds: 3),
                                      ))
                                    }
                                  });
