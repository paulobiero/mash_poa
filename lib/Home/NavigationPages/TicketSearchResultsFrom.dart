...
class TicketSearchResultsFrom extends StatefulWidget {
  const TicketSearchResultsFrom({Key? key, required this.title,required this.buildContext, required this.onPageChanged}) : super(key: key);
  ...
  @override
  State<TicketSearchResultsFrom> createState() => _TicketSearchResultsFrom(this.buildContext,this.onPageChanged);
}
class _TicketSearchResultsFrom extends State<TicketSearchResultsFrom> {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();

    GetListData(context).getAllCities(0,"source").then((value) => {
    setState(() {
isLoading=false;
suggestions=value;
suggestionsCount=suggestions.length;
 ...
 bool isLoading=true;
  _TicketSearchResultsFrom(this.buildContext,this.onPageChanged);
