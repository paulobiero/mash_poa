          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                    "The Internet is an amazing tool. It has the power to change the way we live, and we're starting to see that potential today. With only a few mouse-clicks, you can follow the news, look up facts, buy goods and services, and communicate with others from around the world. It's important to DreamLine to help our customers retain their privacy when they take advantage of all the Internet has to offer.We believe your business is no one else's. Your privacy is important to you and to us. So we'll protect the information you share with us. To protect your privacy, DreamLine follows different principles in accordance with worldwide practices for customer privacy and data protection",
              ...
              Padding(
                padding: EdgeInsets.only(top: 10, right: 20, left: 40),
                child: Text(
                    "$bullet To alert you to product upgrades, special offers, updated information and other new services from DreamLine",
                    style: GoogleFonts.rubik(fontSize: 15)),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(top: 10, right: 20, left: 20),
                child: Text(
                    "Parents or guardians: we want to help you guard your children's privacy. We encourage you to talk to your children about safe and responsible use of their Personal Information while using the Internet.The DreamLine site does not publish content that is targeted to children. However, if you are concerned about your children providing DreamLine any personal information without your consent, DreamLine offers a Kids account. It allows parents to give parental consent for the collection, use and sharing of childrenâ€™s (ages 12 and under) personal information online.",
                    style: GoogleFonts.rubik(fontSize: 15)),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(top: 10, right: 20, left: 20),
                child: Text(
                    "If for some reason you believe DreamLine has not adhered to these principles, please notify us by email at info@mashpoa.com, and we will do our best to determine and correct the problem promptly. Be certain the words Privacy Policy are in the Subject line.",
                    style: GoogleFonts.rubik(fontSize: 15)),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(top: 10, right: 20, left: 20),
                child: Text(
                    "DreamLine will disclose your personal information, without notice, only if required to do so by law or in the good faith belief that such action is necessary to: (a) conform to the edicts of the law or comply with legal process served on DreamLine or the site; (b) protect and defend the rights or property of DreamLine and its family of Websites, and, (c) act in urgent circumstances to protect the personal safety of users of DreamLine, its Websites, or the public",
                    style: GoogleFonts.rubik(fontSize: 15)),
              ),
