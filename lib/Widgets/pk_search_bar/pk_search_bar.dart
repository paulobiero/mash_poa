...
import 'package:mash/Widgets/pk_search_bar/scaled_tile.dart';
import 'package:mash/Widgets/pk_search_bar/search_bar_style.dart';
...
class SearchBar<T> extends StatefulWidget {
  ...
  SearchBar({
    ...
    this.cancellationWidget = const Icon(Icons.clear),
